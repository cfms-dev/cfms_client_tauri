...
const en = {
  ...
  files: {
    ...
    authorize: 'Authorize',
    authorizeEntityTypePrompt: 'Authorize a user or group?',
    authorizeEntityPrompt: 'Username or group name:',
    authorizeAccessPrompt: 'Access types (comma separated: read, write, move, manage):',
    authorizeAccessError: 'Select at least one valid access type.',
    authorizeEndPrompt: 'Access expires at:',
    authorizeEndError: 'The expiry time must be a valid future time.',
    accessGranted: 'Access authorized for {name}.',
...
const zh_CN = {
  ...
  files: {
    ...
    authorize: '授权',
    authorizeEntityTypePrompt: '授权给用户还是用户组？',
    authorizeEntityPrompt: '用户名或用户组名：',
    authorizeAccessPrompt: '访问类型（用英文逗号分隔：read, write, move, manage）：',
    authorizeAccessError: '请至少选择一个有效访问类型。',
    authorizeEndPrompt: '授权过期时间：',
    authorizeEndError: '过期时间必须是有效的未来时间。',
    accessGranted: '已为 {name} 授权访问。',
