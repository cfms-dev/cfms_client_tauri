export const en = {
  ...
  appLock: {
    ...
    unlock: {
      ...
      platformButton: 'Use device unlock / passkey',
    ...
    settings: {
      title: 'App Lock',
      description: 'PIN, device unlock, fingerprint and passkey unlock',
      ...
      platformDescription: 'Use a device passkey, biometric unlock, or screen lock when available.',
      available: 'Available',
