export const en = {
  ...
  settings: {
    ...
    appearance: {
      ...
      colorSchemeHint: 'Use a light or dark interface, or switch with the operating system.',
      light: 'Light',
      ...
      userScope: 'These settings apply only to the signed-in user and are stored in their encrypted preference file.',
      globalScope: 'These settings apply to all signed-out screens and are stored in application-wide configuration.',
